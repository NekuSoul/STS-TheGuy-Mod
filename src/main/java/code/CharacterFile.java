...
import static code.CharacterFile.Enums.THE_GUY_COLOR;
...
public class CharacterFile extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_GUY;
        @SpireEnum(name = "THE_GUY_COLOR")
        public static AbstractCard.CardColor THE_GUY_COLOR;
        @SpireEnum(name = "THE_GUY_COLOR")
