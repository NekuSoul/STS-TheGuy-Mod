...
public class ModFile implements
    ...
    public static final String modID = "TheGuyMod"; //TODO: Change this.
    ...
    public ModFile() {
        ...
        BaseMod.addColor(CharacterFile.Enums.THE_GUY_COLOR, characterColor, characterColor, characterColor,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CharacterFile(CharacterFile.characterStrings.NAMES[1], CharacterFile.Enums.THE_GUY),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CharacterFile.Enums.THE_GUY);
