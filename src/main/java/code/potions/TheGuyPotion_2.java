...
public class TheGuyPotion_2 extends AbstractEasyPotion {
    ...
    public TheGuyPotion_2() {
        super(ID, PotionRarity.PLACEHOLDER, PotionSize.MOON, new Color(0.2f, 0.4f, 0.9f, 1f), new Color(0.6f, 0.8f, 1.0f, 1f), null, CharacterFile.Enums.THE_GUY, ModFile.characterColor);
    }
